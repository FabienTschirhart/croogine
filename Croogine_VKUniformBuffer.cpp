...
void Croogine::createUniformBuffers() {
...
void Croogine::updateUniformBuffer(uint32_t currentImage) {
    ...
    ubo.view = glm::lookAt(glm::vec3(-10.0f, 0.0f, 2.5f), glm::vec3(10.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
