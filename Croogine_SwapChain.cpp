...
namespace Croogine {
    ...
    CroogineSwapChain::~CroogineSwapChain() {
    ...
    VkResult CroogineSwapChain::acquireNextImage(uint32_t* imageIndex) {
        vkWaitForFences(
            device.getDevice(),
            1,
    ...
    VkResult CroogineSwapChain::submitCommandBuffers(
    ...
    void CroogineSwapChain::createSwapChain() {
    ...
    void CroogineSwapChain::createImageViews() {
    ...
    void CroogineSwapChain::createRenderPass() {
    ...
    void CroogineSwapChain::createFramebuffers() {
    ...
    void CroogineSwapChain::createDepthResources() {
    ...
    void CroogineSwapChain::createSyncObjects() {
    ...
    VkSurfaceFormatKHR CroogineSwapChain::chooseSwapSurfaceFormat(
    ...
    VkPresentModeKHR CroogineSwapChain::chooseSwapPresentMode(
        ...
        std::cout << "Mailbox mode not found : V-Sync is used instead" << std::endl;
        return VK_PRESENT_MODE_FIFO_KHR;
    }

    VkExtent2D CroogineSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
    ...
    VkFormat CroogineSwapChain::findDepthFormat() {
