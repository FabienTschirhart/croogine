...
namespace Croogine {
	...
	void CroogineCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
	...
	void CroogineCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
		setViewDirection(position, target - position, up);
	}

	void CroogineCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) {
