...
namespace Croogine {
    ...
    void CrooginePipeline::createGraphicsPipeline(
        ...
        assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot create graphics pipeline because no pipelineLayout is provided in configInfo");
        assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot create graphics pipeline because no renderPass is provided in configInfo");


        //Get Vertex and Fragments shaders
        ...
        auto bindingDescriptions = CroogineModel::Vertex::getBindingDescriptions();
        auto attributeDescriptions = CroogineModel::Vertex::getAttributeDescriptions();
    ...
    void CrooginePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
